---
name: design-review
description: "Get design feedback as you work. Use when you want a second set of eyes on your designs - share a pitch, Figma links, or screenshots and get direct, opinionated feedback grounded in Kajabi's design principles."
---
...
1. Designer shares what they're working on (pitch, Figma links, screenshots, description)
...
### Figma MCP
- When the designer pastes a Figma URL, use the Figma MCP to fetch the frames directly
- Describe what you see and confirm your understanding before giving feedback

### Linear MCP
- If the designer shares a Linear link to a pitch, use Linear MCP to fetch the content
- Extract the problem, who it's for, and scope from the pitch
...
Users can provide Linear and Figma links upfront to skip questions:
...
3. Describe what you see in the designs and confirm understanding
4. Give feedback
...
2. Fetch all Figma frames (in parallel)
3. Summarize what you found and describe what you see
4. Confirm understanding, then give feedback
...
- A link to the pitch
- A Figma link
- Screenshots of a local branch

Or all three - whatever you've got.

**Tip:** You can also run `/design-review <linear-url> <figma-urls...>` to skip questions."
...
1. **Analyze everything** they provided - pitch content, Figma frames, screenshots, descriptions
...
1. `references/kajabi-product-design-principles.md` - the three core principles
2. `references/kajabi-design-framework.md` - the five framework principles
3. `references/ui-patterns.md` - specific UI guidance

### What to evaluate:

**1. Zoom out before you zoom in**
- How does this fit with the rest of Kajabi?
- Are there overlapping features that do similar things? (Search help.kajabi.com or kajabi.com if unsure)
...
Structure your feedback around the three principles, but don't be rigid about it. Lead with the most important observations.
